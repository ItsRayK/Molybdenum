...
From player you can also play custom creations (See *BUILDER* on how to create one)
	...
	You will be presented with a list of ALL of the levels including Levels 1-15 to choose from.
...
By setting the level name to anything that does not contain the word "Level" (i.e. Custom 2) you will be creating a brand new
	level which can be played when you return as the player.
...
SAVE A LEVEL:
Levels will be saved by what is set as the level name .txt (i.e. Level 3.txt)
