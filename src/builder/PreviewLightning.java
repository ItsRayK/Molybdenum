...
public class PreviewLightning extends JFrame {
	...
	public PreviewLightning(String n, Lightning l, Score oneStarScore, Score twoStarScore, Score threeStarScore, int t) {
		timer = t;
		name = n;
		level = l;
	...
	public static void Lightning(Lightning level) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PreviewLightning frame = new PreviewLightning("default", level, null, null, null, 0);
	...
	private void initializeView() {
		...
		starimg1.setIcon(new ImageIcon(PreviewLightning.class.getResource("/images/starlevel.png")));
		contentPane.add(starimg1);

		starimg2.setBounds(797, 302, 90, 90);
		starimg2.setIcon(new ImageIcon(PreviewLightning.class.getResource("/images/starlevel.png")));
		contentPane.add(starimg2);

		starimg3.setBounds(797, 217, 90, 90);
		starimg3.setIcon(new ImageIcon(PreviewLightning.class.getResource("/images/starlevel.png")));
		...
		gridImg.setIcon(new ImageIcon(PreviewLightning.class.getResource("/images/Grid.gif")));
		...
		bg.setIcon(new ImageIcon(PreviewLightning.class.getResource("/images/BackgroundBlank.gif")));
		contentPane.add(bg);
